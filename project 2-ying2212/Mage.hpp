...
class Mage : public Character{
    private:
      /*
        ...
        int level_;
        bool enemy_;
        std::string school_of_magic;
        std::string weapon_;
        bool can_summon_incarnate;
    ...
    public:
    	...
    	/**
            ...
            */
        Mage(const std::string& name, const std::string& race, int vitality, int armor, int level, bool enemy, const std::string school_of_magic, const std::string weapon_ , bool can_summon_incarnate);
    	...
    	/**
            ...
            **/
        bool setSchool (const std::string& magic);
    	...
    	/**
                ...
                @return  : true if setting the variable was successful, false otherwise.
            **/
        bool setCastingWeapon (const std::string & weapons_);
    	...
    	/**
              ...
              @post   : sets the private member variable indicating whether the character can 
                        summon an incarnate
            **/
        void setIncarnateSummon (bool summon_incarnate);
